...
const Blog = (props) => {
    return (
        <div>
            <h3>Blog</h3>
                <p>
                    Blogging was a big part of foundation. It serves as 
                    a way for the students to pratice building a website 
                    using the tools that are currently at our disposal 
                    and adapting to new tech as they are learnt.
                </p>
                <p>
